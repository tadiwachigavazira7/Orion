// ============================================================
// integrations/impinj/ImpinjRfidReader.kt
//
// TODO: NOT IMPLEMENTED. This is a signature-only stub.
//
// Real Impinj RFID SDK details (dependency coordinates, reader connection
...
//
// When Impinj SDK integration details are available:
//   - Add the Impinj SDK dependency to app/build.gradle.kts (or a
//     dedicated module) — scoped to this package only.
//   - Implement connect/startInventory/stopInventory/disconnect against
//     the real SDK lifecycle.
//   - Convert every Impinj SDK tag-read callback into an RfidObservation
...
// ============================================================
package com.orion.integrations.impinj

import com.orion.core.rfid.RfidObservation
import com.orion.core.rfid.RfidReader
import kotlinx.coroutines.flow.Flow

class ImpinjRfidReader : RfidReader {
    override val observations: Flow<RfidObservation>
        get() = throw NotImplementedError(
            "Impinj RFID SDK integration is not implemented — real SDK details are required."
        )
